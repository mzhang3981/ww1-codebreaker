    ...
    const levels = [
        ...
        // ===== LEVEL 2: ADFGVX CIPHER =====
        {
            ...
            briefing: {
                ...
                date: "June 1, 1918",
                text: `German forces have launched a massive spring offensive. Our radio operators have intercepted a field message encrypted with the new German ADFGVX cipher. This was a fiendishly complex system that combines a Polybius square substitution with columnar transposition.<br><br>French cryptanalyst Lieutenant Georges Painvin has spent months studying this cipher and has determined the key components. He has identified the Polybius square arrangement and the transposition keyword used for this message.<br><br>You must apply his method to decrypt the intercepted message. Intelligence suggests it contains the target of the next German attack.`,
            ...
            hints: [
                ...
                "The target is a French city north of Paris, which was a strategically vital location on the Western Front."
            ],
        ...
        // ===== LEVEL 3: CHOCTAW CODE TALKERS =====
        {
            ...
            successResult: {
                ...
                history: "In October 1918, Choctaw members of the 141st and 142nd Infantry Regiments transmitted tactical messages in their native language during the Meuse-Argonne Offensive. German intelligence, which had been successfully tapping American phone lines, was completely baffled. Within 24 hours of deploying the Choctaw code talkers, the tide of battle shifted. The Germans could no longer anticipate American movements. This was the first known use of Native American languages for military communications. This would be a practice that would be expanded with Navajo code talkers in World War II."
            },
            failResult: {
